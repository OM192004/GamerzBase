    ...
    <div className="bg-newgray text-white rounded-lg overflow-hidden shadow-lg transform transition-all hover:scale-102">
      ...
      <div className="p-6">
        ...
        <div className='group  relative mt-5 max-w-fit mx-auto'>
            <Link to="/EventDetails" className="text-line text-sm font-semibold min-h-fit px-2.5 py-1  rounded-md duration-300">
              READ MORE...
            </Link>
            <span className="absolute left-0 bottom-0 w-full h-0.5 bg-white scale-x-0 group-hover:scale-x-90 transition-transform duration-300 origin-center mt-7"></span>
          </div>
      </div>
    </div>
  );
